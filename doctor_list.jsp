                ...
                <table width="90%" border="0" align="center" cellpadding="5" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td width="811" align="center" valign="top">
                            ...
                            <table rules="rows" width="1086" border="1" align="center" cellpadding="2" cellspacing="2">
                                <tr>
                                    <td bgcolor="#1D3752">
                                        <h3><span class="style20">Doctor Id</span></h3>
                                    </td>
                                    <td bgcolor="#1D3752">
                                        <h3>Name</h3>
                                    </td>
                                    ...
                                    <td bgcolor="#1D3752">
                                        <h3><span class="style20">Email</span></h3>
                                    </td>
                                    <td bgcolor="#1D3752">
                                        <h3><span class="style20">Phone</span></h3>
                                    </td>
                                    <td bgcolor="#1D3752">
                                        <h3><span class="style20">Gender</span></h3>
                                    </td>
                                    <td bgcolor="#1D3752">
                                        <h3><span class="style20">Qualification</span></h3>
                                    </td>
                                    <td bgcolor="#1D3752">
                                        <h3><span class="style20">Experience</span></h3>
                                    </td>
                                    <td bgcolor="#1D3752">
                                        <h3><span class="style20">Age</span></h3>
                                    </td>
                                    <td bgcolor="#1D3752">
                                        <h3><span class="style20">Practising At</span></h3>
                                    </td>
                                    <td bgcolor="#1D3752">
                                        <h3><span class="style20">Other Details</span></h3>
                                    </td>
                                </tr>
                                <% String query="select * from doctor" ; ResultSet rs=st.executeQuery(query);
                                    while(rs.next()) { %>
                                    <tr>
